...
const Footer = () => {
  ...
  const certificates = {
    iso: {
      image: "/public/iso-pic.jpg", // Using your actual ISO certificate image
      title: "ISO 9001:2015 Quality Management System Certificate"
    },
    halal: {
      image: "/public/halah-pic.jpg", // Using your actual HALAL certificate image  

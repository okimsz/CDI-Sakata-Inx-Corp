...
const heroImages = [
  '/public/bg-cdi.png',
  '/public/cd-building.jpg',
];

const stats = [
  { label: 'Founded', value: '1964', img: '/public/cd-building.jpg' },
  { label: 'Years of Excellence', value: '60+', img: '/public/building.jpg' },
  { label: 'Countries', value: '15+', img: '/public/china1.jpg' },
  { label: 'Trusted Partner', value: 'Global', img: '/public/cdipic1.jpg' },
];
...
const Hero = () => {
  ...
  <div className="absolute inset-0 z-0">
    <video
      ...
      playsInline
    >
      <source src="/public/newcdi.mp4" type="video/mp4" />
